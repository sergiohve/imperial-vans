...
const metadata = {
    ...
    icons: {
        icon: [
            ...
            {
                url: '/fragment/themes/imperial/favicons/apple-touch-icon-72x72.png',
                sizes: '72x72',
                rel: 'apple-touch-icon'
            },
            {
                url: '/fragment/themes/imperial/favicons/apple-touch-icon-114x114.png',
                sizes: '114x114',
                rel: 'apple-touch-icon'
            }
        ]
    ...
    twitter: {
        ...
        description: "Especialistas en conversiones de unidades de lujo, incorporando tecnología, calidad y diseño con resultados únicos.",
        images: [
            "https://www.imperialvans.com.mx/fragment/themes/imperial/design/imgs/logo-imperial.png"
        ]
    }
};
